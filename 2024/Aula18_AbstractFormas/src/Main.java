	...
	public static void main(String args[]) {
		...
		do {
			...
			opt = Integer.parseInt(JOptionPane.showInputDialog(
							...
							+ "0 - Sair"));
			if (opt == 1) {
				int opt2 = Integer.parseInt(JOptionPane.showInputDialog(
				...
				case 2:
					...
					break;
				case 3:
					String nome = JOptionPane.showInputDialog("Digite o nome do Círculo");
					double largura = Double.parseDouble( 
							JOptionPane.showInputDialog("Digite a largura do círculo")
							);
					Circle circle = new Circle(largura, nome);
					formas.add(circle);
					break;
				}
			} else if (opt == 2) {
				int opt3 = Integer.parseInt(JOptionPane.showInputDialog(
								...
								+ "3 - Visualizar Círculos \n"
								+ "4 - Ver todas as formas"));
				String output = "";
				switch (opt3) {
				case 1:
					output = "";
				...
				case 3:
					...
					for(Forma2D forma : formas) {
						if(forma instanceof Circle) {
							output = output + "Nome: "+forma.getNome()+
									" - Área: " + forma.area();
						}
					}
					break;
